...
insert into EXPERIMENTOS (NIF_INV, NOMBRE, FECHA_INICIO, FECHA_FIN) values ('X3024293T','Setas Rellenas De Bacalao', str_to_date('01/03/2019', '%d/%m/%Y'),str_to_date('01/05/2019','%d/%m/%Y'));
insert into EXPERIMENTOS values ('A1234-B','59090698G','Setas Rellenas De Bacalao', str_to_date('01/03/2019','%d/%m/%Y'), str_to_date('01/05/2019', '%d/%m/%Y'));
insert into EXPERIMENTOS values ('1234-B','X3024293T','Setas Rellenas De Bacalao',  str_to_date('01/03/2019','%d/%m/%Y'), str_to_date('01/05/2019', '%d/%m/%Y'));

insert into EXPERIMENTOS values ('AA1234-B','X3024293T','Setas Rellenas De Bacalao',str_to_date('01/03/2019','%d/%m/%Y'), str_to_date('01/05/2019', '%d/%m/%Y'));
insert into EXPERIMENTOS values ('A1234B','X3024293T','Setas Rellenas De Bacalao',  str_to_date('01/03/2019','%d/%m/%Y'), str_to_date('01/05/2019', '%d/%m/%Y'));
insert into EXPERIMENTOS values ('A1234-BB','X3024293T','Setas Rellenas De Bacalao',str_to_date('01/03/2019','%d/%m/%Y'), str_to_date('01/05/2019', '%d/%m/%Y'));

insert into EXPERIMENTOS values ('A1234-7','X3024293T','Setas Rellenas De Bacalao', str_to_date('01/03/2019','%d/%m/%Y'), str_to_date('01/05/2019', '%d/%m/%Y'));
insert into EXPERIMENTOS values ('AA234-B','X3024293T','Setas Rellenas De Bacalao', str_to_date('01/03/2019','%d/%m/%Y'), str_to_date('01/05/2019', '%d/%m/%Y'));
insert into EXPERIMENTOS values ('A1234BB','X3024293T','Setas Rellenas De Bacalao', str_to_date('01/03/2019','%d/%m/%Y'), str_to_date('01/05/2019', '%d/%m/%Y'));

insert into EXPERIMENTOS values ('A12345B','X3024293T','Setas Rellenas De Bacalao', str_to_date('01/03/2019','%d/%m/%Y'), str_to_date('01/05/2019', '%d/%m/%Y'));
insert into EXPERIMENTOS values ('A1234-B','X3024293T','Setas Rellenas De Bacalao', str_to_date('08/03/2019','%d/%m/%Y'), str_to_date('01/05/2019', '%d/%m/%Y'));
insert into EXPERIMENTOS values ('A1234-B','X3024293T','setas Rellenas De Bacalao', str_to_date('01/03/2019','%d/%m/%Y'), str_to_date('01/05/2019', '%d/%m/%Y'));
...
insert into VERSIONES (COD_EXP, FECHA_PRUEBA) values 'A1234-A', str_to_date('06/04/2019 11:00','%d/%m/%Y %H:%i'));
insert into VERSIONES values ('1.2','A5678-B',  str_to_date('06/04/2019 11,00', '%d/%m/%Y %H:%i'));
insert into VERSIONES values ('0','A1234-B',    str_to_date('06/04/2019 11:00', '%d/%m/%Y %H:%i'));

insert into VERSIONES values ('.','A1234-B',    str_to_date('06/04/2019 11:00', '%d/%m/%Y %H:%i'));
insert into VERSIONES values ('.2','A1234-B',   str_to_date('06/04/2019 11:00', '%d/%m/%Y %H:%i'));
insert into VERSIONES values ('1.','A1234-B',   str_to_date('06/04/2019 11:00', '%d/%m/%Y %H:%i'));

insert into VERSIONES values ('1..1','A1234-B', str_to_date('06/04/2019 11:00', '%d/%m/%Y %H:%i'));
insert into VERSIONES values ('0.0','A1234-B',  str_to_date('06/04/2019 11:00', '%d/%m/%Y %H:%i'));

insert into VERSIONES values ('1.0','A1234-B',  str_to_date('06/04/2019 11:00', '%d/%m/%Y %H:%i'));
insert into VERSIONES values ('10.0','A1234-B', str_to_date('06/04/2019 11:00', '%d/%m/%Y %H:%i'));

#la siguiente tiene que aceptarla
insert into VERSIONES values ('10.10','A1234-B', str_to_date('06/04/2019 11:00', '%d/%m/%Y %H:%i'));

insert into VERSIONES values ('1.2','A1234-B', str_to_date('05/04/2019 11:00', '%d/%m/%Y %H:%i'));
insert into VERSIONES values ('1.2','A1234-B', str_to_date('07/04/2019 11:00', '%d/%m/%Y %H:%i'));
insert into VERSIONES values ('1.2','A1234-B', str_to_date('06/04/2019 14:01', '%d/%m/%Y %H:%i'));

insert into VERSIONES values ('1.2','A1234-B', str_to_date('06/04/2019 10:59', '%d/%m/%Y %H:%i'));
insert into VERSIONES values ('1.2','A1234-B', str_to_date('06/04/2019 15:00', '%d/%m/%Y %H:%i'));
insert into VERSIONES values ('1.2','A1234-B', str_to_date('06/04/2019 11:00', '%d/%m/%Y %H:%i'));
