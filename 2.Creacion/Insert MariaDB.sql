...
insert into EXPERIMENTOS values ('A1234-A','49090698G','Tartar De Cigala', str_to_date('01/02/2019','%d/%m/%Y'),str_to_date('01/04/2019','%d/%m/%Y'));
insert into EXPERIMENTOS values ('A1234-C','49129431M','Templo De Queso', str_to_date('01/04/2019','%d/%m/%Y'),str_to_date('01/06/2019','%d/%m/%Y'));
insert into EXPERIMENTOS values ('A1234-D','49131465S','Chocolate Frio', str_to_date('01/05/2019','%d/%m/%Y'),str_to_date('01/07/2019','%d/%m/%Y'));


str_to_date('06/04/2019 11:00','%d/%m/%Y %H:%i')

VERSIONES

insert into VERSIONES values ('1.2','A1234-B', str_to_date('06/04/2019 11:00','%d/%m/%Y %H:%i'));
insert into VERSIONES values ('1.1','A1234-A', str_to_date('16/02/2019 11:00','%d/%m/%Y %H:%i'));
insert into VERSIONES values ('1.2','A1234-A', str_to_date('02/03/2019 11:00','%d/%m/%Y %H:%i'));
insert into VERSIONES values ('1.3','A1234-A', str_to_date('16/03/2019 11:00','%d/%m/%Y %H:%i'));
insert into VERSIONES values ('1.1','A1234-B', str_to_date('16/03/2019 11:00','%d/%m/%Y %H:%i'));

insert into VERSIONES values ('1.3','A1234-B', str_to_date('20/04/2019 11:00','%d/%m/%Y %H:%i'));
insert into VERSIONES values ('1.1','A1234-C', str_to_date('20/04/2019 11:00','%d/%m/%Y %H:%i'));
insert into VERSIONES values ('1.2','A1234-C', str_to_date('04/05/2019 11:00','%d/%m/%Y %H:%i'));
insert into VERSIONES values ('1.1','A1234-D', str_to_date('04/05/2019 11:00','%d/%m/%Y %H:%i'));

insert into VERSIONES values ('0.1','A1234-D', str_to_date('04/05/2019 11:00','%d/%m/%Y %H:%i'));
insert into VERSIONES values ('3.1.7','A1234-D', str_to_date('04/05/2019 11:00','%d/%m/%Y %H:%i'));
...
insert into INGREDIENTES_POR_VERSION values ('X', 'A1234-B','1.3','200G');
...
insert into INGREDIENTES_POR_VERSION values ('P', 'A1234-C','1.2', '0.03L');
